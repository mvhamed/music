...
from SedthonMusic import app as Client
...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/UI_XB) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/UI_XB) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/UI_XB)\n [🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱](https://t.me/UI_XB)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/UI_XB) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/UI_OS"),
                
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="ahmed"),
                ],
                ...
                [
                    InlineKeyboardButton(
                        "الجروب", url=f"https://t.me/UI_OS"
                    ),
                    InlineKeyboardButton(
                        "القناة", url=f"https://t.me/UI_XB"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "ᖴ᥆ᖇ 𝒎𝒐𝒅𝒚. 🐉", url="https://t.me/UP_UO"
                    )
                ],
            ]
        ),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/UI_XB) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/UI_XB) \n ※[These Features AI Based](https://t.me/UI_XB)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="UP_UO"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate", url=f"https://t.me/UI_XB"),
                ],
                [
                    InlineKeyboardButton(
                        "Group", url=f"https://t.me/UI_OS"
                    ),
                    InlineKeyboardButton(
                        "Channel", url=f"https://t.me/UI_XB"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
@Client.on_callback_query(filters.regex("UP_UO"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🔱 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع مودي من هن : @UP_UO **
\n __ Developer by [ᖴ᥆ᖇ 𝒎𝒐𝒅𝒚. 🐉](https://t.me/UP_UO)""",
        reply_markup=InlineKeyboardMarkup(
...
@Client.on_callback_query(filters.regex("ahmed"))
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
...
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b> يمكنك التواصل معي \n عن طريق معرفي اول جروب التواصل بلاسفل..↑↓ \n\n [ᖴ᥆ᖇ 𝒎𝒐𝒅𝒚. 🐉](https://t.me/UP_UO)</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("القناة", url=f"https://t.me/UI_XB"),
                    InlineKeyboardButton("الجروب", url=f"https://t.me/UI_OS"),
                ],
                [
                    InlineKeyboardButton("البوت", url=f"https://t.me/ZEMRBOT"),
                    InlineKeyboardButton("التواصل", url=f"https://t.me/AXR0BOT"),
                ],
                [InlineKeyboardButton("ᖴ᥆ᖇ 𝒎𝒐𝒅𝒚. 🐉", url=f"https://t.me/UP_UO")],
            ]
        ),
    )
